...
namespace Xcy\DcatServerMonitor\Http\Controllers;

use Dcat\Admin\Layout\Content;
use Dcat\Admin\Admin;
use Illuminate\Routing\Controller;
use Xcy\DcatServerMonitor\Http\Pages\ServerPage;

class DcatServerMonitorController extends Controller
{
    public function index(Content $content): Content
    {
        return $content->title("服务监控")->body(new ServerPage());
    }

    /**
     * 获取cpu信息
     */
    public function getCpuInfo(): \Illuminate\Http\JsonResponse
    {
        if (PHP_OS == 'Linux') {
...
//        $result['dcat_admin_version'] = Composer::getVersion("dcat/laravel-admin");
        $result['dcat_admin_version'] = Admin::VERSION;
